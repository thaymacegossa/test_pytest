...
def test_create_product_successfully(base_url):
...
def test_create_product_missing_required_fields_returns_error(base_url):
    response = requests.post(f"{base_url}/produtos", json={"nome": "Produto Incompleto"})
